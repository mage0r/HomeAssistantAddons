...
REPO="GoSungrow"
URL="https://api.github.com/repos/triamazikamno/${REPO}/releases/latest"
...
# cd /tmp
# wget -O- https://github.com/triamazikamno/GoSungrow/releases/download/v${GOSUNGROW_VERSION}/GoSungrow-linux_${ARCH}.tar.gz | tar zxvf - GoSungrow
